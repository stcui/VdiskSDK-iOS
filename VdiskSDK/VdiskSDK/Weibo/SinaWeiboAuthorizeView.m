...
static CGFloat kBorderGray[4] = {0.0, 0.0, 0.0, 0.2};
...
{
    [self drawRect:rect fill:kBorderGray radius:4.0f];
...
- (void)webViewDidFinishLoad:(UIWebView *)aWebView
{
    ...
    [aWebView stringByEvaluatingJavaScriptFromString:@"             \
     ...
     oMeta.setAttribute('content', 'yes');                          \
     oMeta.setAttribute('name', 'apple-mobile-web-app-capable');    \
     document.getElementsByTagName('head')[0].appendChild(oMeta);"];
     */
    
    CGFloat scaleFactor = SinaWeiboIsDeviceIPad() ? 1.0f : 0.9f;
    NSString *width = SinaWeiboIsDeviceIPad() ? @"320" : @"device-width";
    
    [aWebView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"                                                  \
                                                                                                                                    \
     ...
     for(var i=0; i<meta.length; i++){                                                                                              \
         ...
         if (meta[i].getAttribute('name') == 'viewport') {                                                                          \
                                                                                                                                    \
             meta[i].setAttribute('content', 'width=%@, minimum-scale=%.2f, maximum-scale=%.2f, user-scalable=no');       \
             break;                                                                                                                 \
         }                                                                                                                          \
                                                                                                                                    \
